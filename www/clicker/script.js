...
let upgrades = [
	...
	{ name: 'Plentiful Dreams I', cost: 1, unlock_amount: 3, unlock_automation: -1, result: "newparticle", factor: "supermushroom", owned: false },
	{ name: 'Plentiful Dreams II', cost: 1, unlock_amount: 6, unlock_automation: -1, result: "newparticle", factor: "twitter", owned: false },
	{ name: 'Plentiful Dreams III', cost: 1, unlock_amount: 9, unlock_automation: -1, result: "newparticle", factor: "youtube", owned: false },
	{ name: 'Plentiful Dreams IV', cost: 1, unlock_amount: 11, unlock_automation: -1, result: "newparticle", factor: "windows", owned: false },
	{ name: 'Plentiful Dreams V', cost: 1, unlock_amount: 13, unlock_automation: -1, result: "newparticle", factor: "apple", owned: false },
	{ name: 'Plentiful Dreams VI', cost: 1, unlock_amount: 15, unlock_automation: -1, result: "newparticle", factor: "mcdonalds", owned: false },
	{ name: 'Plentiful Dreams VII', cost: 1, unlock_amount: 17, unlock_automation: -1, result: "newparticle", factor: "nike", owned: false },
